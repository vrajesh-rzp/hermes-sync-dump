...
company: Razorpay
relationship: Razorpay colleague / direct manager / VRM stakeholder
email: sagar.agarwal@razorpay.com
---

# Sagar Agarwal

> Sr Director PM overseeing the Growth charter. Vrajesh's direct manager and the person who sets roadmap priorities, owns the DEPA cadence, and sponsors key vendor onboardings like Bitscale. Currently driving Subscriptions + Gamification and cross-team PM syncs. Active, accountable, and direct.

## State
- **Role:** Sr Director Product Management, Growth team [Source: Gmail, 2026-05-20]
- **Reports to:** Tejas Gowda (VP Product SME Payments)
- **DevRev:** DEVU-11541
- Runs the weekly Growth DEPA (Data / Eng / Product / Analytics) cadence — attendees include Nikhil, Nikunj, Tushar, Varghese, Vrajesh, Suhas, and Gopi [Source: Gmail, 2026-05-20]
- Also running PM Leads cross-team sync and a Devrev + Slack tooling integration sync [Source: Gmail, 2026-05-20]

## What They're Building
- **Subscriptions + Gamification:** Driving April metrics review; waiting on Ramya to surface April Gamification data [Source: Gmail, 2026-05-20]
...
## Open Threads
- Bitscale NDA/vendor agreement blocked on legal (Shivani) — Sagar is manager-sponsor; Nikhil is DRI
- April Gamification metrics blocked on Ramya — Sagar is waiting
- HQL threshold definition blocked on Nikunj — relevant for Growth cadence outcomes
